...
/* harmony import */ var _tracker_page__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./tracker.page */ "./src/app/tracker/tracker.page.ts");
...
/* harmony import */ var _tracker_page__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./tracker.page */ "./src/app/tracker/tracker.page.ts");
/* harmony import */ var _tracker_routing_module__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./tracker-routing.module */ "./src/app/tracker/tracker-routing.module.ts");
...
TrackerPageModule = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["NgModule"])({
        imports: [
            ...
            _tracker_routing_module__WEBPACK_IMPORTED_MODULE_6__["TrackerPageRoutingModule"]
        ],
...
/* harmony import */ var src_classes_point__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! src/classes/point */ "./src/classes/point.ts");
...
const { Haptics } = _capacitor_core__WEBPACK_IMPORTED_MODULE_2__["Plugins"];
const { Geolocation } = _capacitor_core__WEBPACK_IMPORTED_MODULE_2__["Plugins"];
let TrackerPage = class TrackerPage {
    constructor(loadingController, routeService, alertController) {
    ...
    hapticsImpact(style = _capacitor_core__WEBPACK_IMPORTED_MODULE_2__["HapticsImpactStyle"].Heavy) {
        Haptics.impact({
            style
        });
    }
    saveLocation() {
        return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, function* () {
            ...
            try {
                ...
                let coordinates = yield Geolocation.getCurrentPosition(options);
                this.loadingController.dismiss();
    ...
    saveCoordinate(coordinate) {
        const point = new src_classes_point__WEBPACK_IMPORTED_MODULE_5__["Point"](coordinate.longitude, coordinate.latitude, coordinate.accuracy);
    ...
    createRoute() {
        ...
        this.routeService.createRoute(route).subscribe(response => {
            ...
            this.didStartTracking = false;
            this.points = [];
            Haptics.notification({ type: _capacitor_core__WEBPACK_IMPORTED_MODULE_2__["HapticsNotificationType"].SUCCESS });
        }, error => {
            console.log(error);
            Haptics.notification({ type: _capacitor_core__WEBPACK_IMPORTED_MODULE_2__["HapticsNotificationType"].ERROR });
            this.loadingController.dismiss();
...
TrackerPage = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        ...
        template: Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"])(__webpack_require__(/*! raw-loader!./tracker.page.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/tracker/tracker.page.html")).default,
        styles: [Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"])(__webpack_require__(/*! ./tracker.page.scss */ "./src/app/tracker/tracker.page.scss")).default]
    })
], TrackerPage);
...
class Point {
    constructor(longitude, latitude, precision) {
        this.centralSubtendedAngle = (point1, point2) => {
            ...
            return radiansToDegrees(Math.acos(Math.sin(point1LatRadians) * Math.sin(point2LatRadians) +
