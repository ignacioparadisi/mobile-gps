    ...
    function srcServicesRouteServiceTs(module, __webpack_exports__, __webpack_require__) {
      ...
      var RouteService = /*#__PURE__*/function () {
        ...
        _createClass(RouteService, [{
          key: "createRoute",
          value: function createRoute(route) {
            var localUser = src_resources_auth_guard__WEBPACK_IMPORTED_MODULE_3__["AuthGuard"].getUser();
            return this.http.post("https://community-service-ucab.herokuapp.com/api/users/".concat(localUser.id, "/routes"), route);
          }
        }, {
          key: "getRoutesForUser",
          value: function getRoutesForUser() {
            var localUser = src_resources_auth_guard__WEBPACK_IMPORTED_MODULE_3__["AuthGuard"].getUser();

            if (localUser !== null) {
              return this.http.get("https://community-service-ucab.herokuapp.com/api/users/".concat(localUser.id, "/routes"));
            }
          }
        }, {
          key: "getRouteById",
          value: function getRouteById(id) {
            ...
            if (localUser !== null) {
              console.log("https://community-service-ucab.herokuapp.com/api/users/".concat(localUser.id, "/routes/").concat(id));
              return this.http.get("https://community-service-ucab.herokuapp.com/api/users/".concat(localUser.id, "/routes/").concat(id));
            }

            return Object(rxjs__WEBPACK_IMPORTED_MODULE_4__["throwError"])('User is not authenticated');
          }
        }]);
