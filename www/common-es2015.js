...
let RouteService = class RouteService {
    ...
    createRoute(route) {
        ...
        return this.http.post(`https://community-service-ucab.herokuapp.com/api/users/${localUser.id}/routes`, route);
    }
    getRoutesForUser() {
        const localUser = src_resources_auth_guard__WEBPACK_IMPORTED_MODULE_3__["AuthGuard"].getUser();
        if (localUser !== null) {
            return this.http.get(`https://community-service-ucab.herokuapp.com/api/users/${localUser.id}/routes`);
        }
    }
    getRouteById(id) {
        const localUser = src_resources_auth_guard__WEBPACK_IMPORTED_MODULE_3__["AuthGuard"].getUser();
        if (localUser !== null) {
            ...
            return this.http.get(`https://community-service-ucab.herokuapp.com/api/users/${localUser.id}/routes/${id}`);
        }
